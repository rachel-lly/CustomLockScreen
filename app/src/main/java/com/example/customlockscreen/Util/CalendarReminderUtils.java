...
public class CalendarReminderUtils {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static void addCalendarEvent(Context context, String title, String description, long startTime, long endTime,int remindTimeDay) {
        if (context == null) {
            return;
        }
        ...
        values.put(CalendarContract.Reminders.MINUTES, remindTimeDay*24*60);// 提前 remindTime 天有提醒
